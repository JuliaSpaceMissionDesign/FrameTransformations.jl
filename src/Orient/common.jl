...
"""
    orient_rot3_icrf_to_mod(t::Number)
...
"""
function orient_rot3_icrf_to_mod(t::Number)
...
"""
    orient_rot3_icrf_to_tod(t::Number; iauModel=iau2006b)

Compute the rotation matrix from the International Celestial Reference Frame (ICRF) to 
the True Equator of Date at time `t`, expressed in TT seconds since `J2000`.
...
(`iauModel`).
"""
function orient_rot3_icrf_to_tod(t::Number; iauModel=iau2006b)
    return orient_bias_precession_nutation(iauModel, t)
end
