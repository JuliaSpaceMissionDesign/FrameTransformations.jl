...
function add_axes_bcrtod!(frames::FrameSystem{O, T}, 
    ...
    _axes_bcrtod!(frames, data, point_id(center), String(point_name(center)), axes, parent)
end

function _axes_bcrtod!(frames::FrameSystem{O, T}, 
...
function add_axes_bci2000!(frames::FrameSystem{O, T}, 
    ...
    _axes_bci2000!(frames, data, point_id(center), axes, parent)
end

function _axes_bci2000!(frames::FrameSystem{O, T}, 
