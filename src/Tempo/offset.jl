...
@inline function _apply_offset(second::N,
    fraction::T, error::T, from::S1,
    to::S2)::Tuple{N, T, T} where {T, N<:Integer, S1<:TimeScale, S2<:TimeScale}
