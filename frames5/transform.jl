...
for (order, axfun1, axfun2, pfun1, pfun2, compfun, vfwd, vbwd) in zip(
        (1, 2, 3, 4), 
        (:get_rotation3, :get_rotation6, :get_rotation9, :get_rotation12), 
        (:_compute_rot3, :_compute_rot6, :_compute_rot9, :_compute_rot12),
        (:get_vector3, :get_vector6, :get_vector9, :get_vector12), 
        (:_compute_vector3, :_compute_vector6, :_compute_vector9, :_compute_vector12),
        (:_get_comp_axes_vector3, :_get_comp_axes_vector6, :_get_comp_axes_vector9, :_get_comp_axes_vector12),
        (:_get_vector3_forward, :_get_vector6_forward, :_get_vector9_forward, :_get_vector12_forward),
        (:_get_vector3_backwards, :_get_vector6_backwards, :_get_vector9_backwards, :_get_vector12_backwards)
    )
