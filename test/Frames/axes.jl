...
@testset "Axes Definitions" verbose=true begin 
    ...
    @testset "Rotating" verbose=false begin 
        ...
        ddf = t->(angle_to_dcm(t, smb), Utils.angle_to_δdcm([t, 1], smb), 
                    Utils.angle_to_δ²dcm([t, 1, 0], smb))        

        dddf = t->(angle_to_dcm(t, smb), Utils.angle_to_δdcm([t, 1], smb), 
                    Utils.angle_to_δ²dcm([t, 1, 0], smb), 
    ...
    @testset "Computable" verbose=false begin 
        ...
        @test_throws ArgumentError add_axes_computable!(F, AXES_COMP, ECLIPJ2000, v1, v2, :Z)

        # test points not defined 
        @test_throws ArgumentError add_axes_computable!(F, AXES_COMP, ECLIPJ2000, v1, v2, :XY)
