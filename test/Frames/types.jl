...
@testset "Frame types" verbose=true begin 
    ...
    @testset "PointNodes" begin 
        ...
        fcn_stv1!(x, t) = x[1:3] .= [1., 2., t] 
        fcn_stv3!(x, t) = x[[4, 2, 8]] .= [6, t, -1.]
    ...
    @testset "FrameSystem" begin 
        ...
        @test typeof(fs1) == FrameSystem{1, Int64, BarycentricDynamicalTime, 
                                        Basic.Ephemeris.NullEphemerisProvider, 3}
        ...
        @test typeof(fs2) == FrameSystem{3, Float64, InternationalAtomicTime, 
                                        Basic.Ephemeris.NullEphemerisProvider, 9}
